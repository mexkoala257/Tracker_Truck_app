...
const VISIBLE_VEHICLES_KEY = "sioux-falls-visible-vehicles";
          ...
          <>
            ...
            <div className="p-3 border-b border-border">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-semibold">Sioux Falls View</span>
              </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-[1000] bg-background/50 backdrop-blur-sm border border-border rounded-lg shadow-xl p-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 pl-2 border-l border-border">
            ...
            <span className="text-[10px] font-mono text-muted-foreground">
              Zoom:{" "}
              <span className="text-primary font-bold">{zoom}</span>
            </span>
          </div>
        </div>
      </div>
